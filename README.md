...
Not built yet: browser dashboard implementation, IAM Access Analyzer proof, real AWS deployment
and runtime tracing
integrations. See [the architecture](docs/architecture.md), [the Phase 3 guide](docs/phase-3.md),
[the Phase 4 guide](docs/phase-4-policy.md), [the Phase 5 guide](docs/phase-5-reasoning.md), and
[the Phase 6 guide](docs/phase-6-orchestration.md).
